...
//            },
            compileNoDep: {
                options: {
                    name: 'moa-noDeps',
                    baseUrl: 'src',
                    mainConfigFile: 'r.noDeps.config.js',
                    optimize: "uglify2",
                    out: 'moa-noDeps.js',
                    uglify2: {
                        output: {
                ...
                options: {
                    ...
                    uglify2: {
                        output: {
                            ...
                            beautify      : false, // beautify output?
                            source_map    : {
                                file : 'moa-noDeps.min.js', // the compressed file name
                                root : 'moa-noDeps.js', // the root URL to the original sources
                                orig : null  // the input source map
                            },  // output a source map
                            bracketize    : false, // use brackets every time?
                            comments      : false, // output comments?
