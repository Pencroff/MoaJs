// This file was automatically generated from "test.lmd.json"
 ...
 * Time: 23:17
 */
function math(require) {
    'use strict';
    var mult = require('mult');
    document.getElementsByTagName('body')[0].text(mult(8, 7));
}
,{
"add": /**
...
"mult": (function (require, exports, module) { /* wrapped by builder */
/**
 * Created with JetBrains WebStorm.
 * Project: MoaJs
 * User: Sergii Danilov
